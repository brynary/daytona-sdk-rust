...
pub struct AccessibilitySetValueRequest {
    #[serde(rename = "id")]
    pub id: String,
...
impl AccessibilitySetValueRequest {
    pub fn new(id: String) -> AccessibilitySetValueRequest {
        AccessibilitySetValueRequest { id, value: None }
    }
}
