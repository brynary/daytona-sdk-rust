...
pub async fn get_user_home_dir(
    configuration: &configuration::Configuration,
) -> Result<models::UserHomeDirResponse, Error<GetUserHomeDirError>> {
...
pub async fn get_version(
    configuration: &configuration::Configuration,
) -> Result<std::collections::HashMap<String, String>, Error<GetVersionError>> {
...
pub async fn get_work_dir(
    configuration: &configuration::Configuration,
) -> Result<models::WorkDirResponse, Error<GetWorkDirError>> {
