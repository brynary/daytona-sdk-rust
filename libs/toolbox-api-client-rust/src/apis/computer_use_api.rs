...
/// struct for typed errors of method [`find_accessibility_nodes`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FindAccessibilityNodesError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status500(models::ErrorResponse),
...
/// struct for typed errors of method [`focus_accessibility_node`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FocusAccessibilityNodeError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status500(models::ErrorResponse),
    Status503(models::ErrorResponse),
...
/// struct for typed errors of method [`get_accessibility_tree`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetAccessibilityTreeError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status500(models::ErrorResponse),
    Status503(models::ErrorResponse),
...
/// struct for typed errors of method [`invoke_accessibility_node`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum InvokeAccessibilityNodeError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status500(models::ErrorResponse),
    Status503(models::ErrorResponse),
...
/// struct for typed errors of method [`set_accessibility_node_value`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SetAccessibilityNodeValueError {
    Status400(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status500(models::ErrorResponse),
    Status503(models::ErrorResponse),
...
pub async fn click(
    ...
    request: models::MouseClickRequest,
) -> Result<models::MouseClickResponse, Error<ClickError>> {
...
pub async fn download_recording(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<reqwest::Response, Error<DownloadRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn drag(
    configuration: &configuration::Configuration,
    request: models::MouseDragRequest,
) -> Result<models::MouseDragResponse, Error<DragError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn find_accessibility_nodes(
    configuration: &configuration::Configuration,
    request: models::FindAccessibilityNodesRequest,
) -> Result<models::AccessibilityNodesResponse, Error<FindAccessibilityNodesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;

    let uri_str = format!("{}/computeruse/a11y/find", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccessibilityNodesResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccessibilityNodesResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<FindAccessibilityNodesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn focus_accessibility_node(
    configuration: &configuration::Configuration,
    request: models::AccessibilityNodeRequest,
) -> Result<serde_json::Value, Error<FocusAccessibilityNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;

    let uri_str = format!("{}/computeruse/a11y/node/focus", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<FocusAccessibilityNodeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_accessibility_tree(
...
) -> Result<models::AccessibilityTreeResponse, Error<GetAccessibilityTreeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_scope = scope;
    let p_query_pid = pid;
    let p_query_max_depth = max_depth;

    let uri_str = format!("{}/computeruse/a11y/tree", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if let Some(ref param_value) = p_query_max_depth {
        req_builder = req_builder.query(&[("maxDepth", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::AccessibilityTreeResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::AccessibilityTreeResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetAccessibilityTreeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn get_computer_use_status(
    configuration: &configuration::Configuration,
) -> Result<models::ComputerUseStatusResponse, Error<GetComputerUseStatusError>> {
...
pub async fn get_computer_use_system_status(
    configuration: &configuration::Configuration,
) -> Result<models::ComputerUseStatusResponse, Error<GetComputerUseSystemStatusError>> {
...
pub async fn get_mouse_position(
    configuration: &configuration::Configuration,
) -> Result<models::MousePositionResponse, Error<GetMousePositionError>> {
...
pub async fn get_recording(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::Recording, Error<GetRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn invoke_accessibility_node(
    configuration: &configuration::Configuration,
    request: models::AccessibilityInvokeRequest,
) -> Result<serde_json::Value, Error<InvokeAccessibilityNodeError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;

    let uri_str = format!("{}/computeruse/a11y/node/invoke", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<InvokeAccessibilityNodeError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_recordings(
    configuration: &configuration::Configuration,
) -> Result<models::ListRecordingsResponse, Error<ListRecordingsError>> {
...
pub async fn move_mouse(
    configuration: &configuration::Configuration,
    request: models::MouseMoveRequest,
) -> Result<models::MousePositionResponse, Error<MoveMouseError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn press_hotkey(
    configuration: &configuration::Configuration,
    request: models::KeyboardHotkeyRequest,
) -> Result<serde_json::Value, Error<PressHotkeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn press_key(
    configuration: &configuration::Configuration,
    request: models::KeyboardPressRequest,
) -> Result<serde_json::Value, Error<PressKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn scroll(
    configuration: &configuration::Configuration,
    request: models::MouseScrollRequest,
) -> Result<models::ScrollResponse, Error<ScrollError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn set_accessibility_node_value(
    configuration: &configuration::Configuration,
    request: models::AccessibilitySetValueRequest,
) -> Result<serde_json::Value, Error<SetAccessibilityNodeValueError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;

    let uri_str = format!("{}/computeruse/a11y/node/value", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<SetAccessibilityNodeValueError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn start_computer_use(
    configuration: &configuration::Configuration,
) -> Result<models::ComputerUseStartResponse, Error<StartComputerUseError>> {
...
pub async fn start_recording(
    configuration: &configuration::Configuration,
    request: Option<models::StartRecordingRequest>,
) -> Result<models::Recording, Error<StartRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn stop_computer_use(
    configuration: &configuration::Configuration,
) -> Result<models::ComputerUseStopResponse, Error<StopComputerUseError>> {
...
pub async fn stop_recording(
    configuration: &configuration::Configuration,
    request: models::StopRecordingRequest,
) -> Result<models::Recording, Error<StopRecordingError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
...
pub async fn take_compressed_region_screenshot(
    ...
    quality: Option<i32>,
    scale: Option<f64>,
) -> Result<models::ScreenshotResponse, Error<TakeCompressedRegionScreenshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_x = x;
    let p_query_y = y;
...
pub async fn take_compressed_screenshot(
    ...
    quality: Option<i32>,
    scale: Option<f64>,
) -> Result<models::ScreenshotResponse, Error<TakeCompressedScreenshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_show_cursor = show_cursor;
    let p_query_format = format;
    let p_query_quality = quality;
...
pub async fn take_region_screenshot(
    ...
    height: i32,
    show_cursor: Option<bool>,
) -> Result<models::ScreenshotResponse, Error<TakeRegionScreenshotError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_x = x;
    let p_query_y = y;
    let p_query_width = width;
...
pub async fn type_text(
    configuration: &configuration::Configuration,
    request: models::KeyboardTypeRequest,
) -> Result<serde_json::Value, Error<TypeTextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_request = request;
