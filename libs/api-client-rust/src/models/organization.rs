...
pub struct Organization {
    ...
    #[serde(rename = "secretQuota")]
    pub secret_quota: f64,
    /// Maximum number of secrets that can be mounted to a single sandbox
    #[serde(rename = "maxSecretsPerSandbox")]
    pub max_secrets_per_sandbox: f64,
