...
pub async fn create_api_key(
    ...
    create_api_key: models::CreateApiKey,
    x_daytona_organization_id: Option<&str>,
) -> Result<models::ApiKeyResponse, Error<CreateApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_create_api_key = create_api_key;
    ...
    req_builder = req_builder.json(&p_body_create_api_key);
...
pub async fn delete_api_key_for_user(
    ...
    name: &str,
    x_daytona_organization_id: Option<&str>,
) -> Result<(), Error<DeleteApiKeyForUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_api_key(
    ...
    name: &str,
    x_daytona_organization_id: Option<&str>,
) -> Result<models::ApiKeyList, Error<GetApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_name = name;
    let p_header_x_daytona_organization_id = x_daytona_organization_id;
...
pub async fn get_current_api_key(
    configuration: &configuration::Configuration,
    x_daytona_organization_id: Option<&str>,
) -> Result<models::ApiKeyList, Error<GetCurrentApiKeyError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_x_daytona_organization_id = x_daytona_organization_id;
...
pub async fn list_api_keys(
    configuration: &configuration::Configuration,
    x_daytona_organization_id: Option<&str>,
) -> Result<Vec<models::ApiKeyList>, Error<ListApiKeysError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_header_x_daytona_organization_id = x_daytona_organization_id;
