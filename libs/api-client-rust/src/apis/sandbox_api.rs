...
pub async fn list_sandboxes(
    ...
    max_memory_gib: Option<f64>,
    min_disk_gib: Option<f64>,
    max_disk_gib: Option<f64>,
    ...
    let p_query_min_memory_gib = min_memory_gib;
    let p_query_max_memory_gib = max_memory_gib;
    let p_query_min_disk_gib = min_disk_gib;
    let p_query_max_disk_gib = max_disk_gib;
    ...
    if let Some(ref param_value) = p_query_min_memory_gib {
        req_builder = req_builder.query(&[("minMemoryGib", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_max_memory_gib {
        req_builder = req_builder.query(&[("maxMemoryGib", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_min_disk_gib {
        req_builder = req_builder.query(&[("minDiskGib", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_max_disk_gib {
